...
{
    [TestFixture]
    public class PassphraseCheckerTests
    {
        private static string[] problemInputFromAdventOfCode =
            new string[]
            {
        ...
        {
            var passphrases = new string[] { "aa bb cc dd ee",
                                             "aa bb cc dd aa",
                                             "aa bb cc dd aaa"
                                           };

            var result = PassphraseChecker.PassphrasesValidPartA(passphrases);
        ...
        {
            var result = PassphraseChecker.PassphrasesValidPartA(problemInputFromAdventOfCode);
